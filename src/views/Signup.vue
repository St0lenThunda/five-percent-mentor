    ...
    <div class="backdrop-blur-lg bg-white/10 rounded-3xl shadow-2xl p-8 max-w-md w-full border border-white/20">
      <div class="text-center mb-8">
        <h1 class="text-4xl font-bold mb-2">
          <span class="text-transparent bg-clip-text bg-gradient-to-r from-gold-500 to-primary-500">Build Together</span> ✊🏿
        </h1>
        <p class="text-purple-200">Begin Your Journey</p>
      </div>
      ...
      <form @submit.prevent="handleSignup" class="space-y-6">
        ...
        <div>
          <label for="username" class="block text-sm font-medium text-purple-200 mb-2">Username</label>
          <input
            id="username"
            v-model="username"
            type="text"
        ...
        <div>
          ...
          <input
            ...
            placeholder="••••••••"
          />
          <p class="text-xs text-purple-300/70 mt-1">Minimum 8 characters</p>
        </div>
      ...
      <div class="mt-6 text-center">
        <router-link to="/login" class="text-sm text-purple-300 hover:text-primary-400 transition-colors">
